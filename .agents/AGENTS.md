...
1. **No Edits Without Prior Approval**: NEVER modify, create, or edit any code files or project assets without first presenting a proposal/plan and receiving explicit confirmation from the user.
